...
+ (NSCalendar *)gregorian {
    if (gregorian_DateUtil == nil) {
        gregorian_DateUtil = [[NSCalendar alloc] initWithCalendarIdentifier:NSGregorianCalendar];
    }
    return gregorian_DateUtil;
}
